    ...
    SlideInTransitionDialog(onDismissRequest = onDismissRequest) { helper ->
        Surface(
            ...
            Column(
                ...
                SelectionList(modifier = Modifier.weight(weight = 1f, fill = false), labels = labels, selectedIndex = selectedIndex, onSelect = {
                    selectedIndex = it
                })
...
@Composable
private fun Title(modifier: Modifier, title: String) {
...
@Composable
private fun Message(modifier: Modifier, message: String) {
    Box(modifier = modifier) {
        Text(
            text = message,
